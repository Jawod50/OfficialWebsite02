...
import robot01Medium from "../../public/images/robots/robot01-Medium.png";
import robot02Medium from "../../public/images/robots/robot02-Medium.png";
import robot03Medium from "../../public/images/robots/robot03-Medium.png";
import robot04Medium from "../../public/images/robots/robot04-Medium.png";
		...
		<div className="robot-parent">
			...
			<div className="content00">
				<div className="robot011">
					...
					<Image src={robot01Medium} alt="Fire Figthing Robot Image" className="photo011" />
				...
				<div className="robot022">
					...
					<Image src={robot02Medium} alt="Line Tracing Robot Image" className="photos022" />
				...
				<div className="robot033">
					...
					<Image src={robot03Medium} alt="Flying Car Image" className="photo033" />
				...
				<div className="robot044">
					...
					<Image src={robot04Medium} alt="Sumo Bot Image" className="photo044" />
