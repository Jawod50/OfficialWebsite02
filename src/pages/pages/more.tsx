		...
		<div>
			...
			<div className="WD-section">
				...
				<div className="WD-body">
					...
					<Image width={250} height={100} src={"./images/logos/SW_JS_VisualStudioCode.png"} alt="JS_VisualStudioCode" />
				</div>
			</div>
			...
			<div className="WD-section">
				...
				<div className="WD-body">
					...
					<Image width={250} height={100} src={"./images/logos/SW_CS_WFANetFramework.png"} alt="CSHP_WFANetFramework" />
					<Image
						width={250}
						height={100}
