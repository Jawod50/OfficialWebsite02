		...
		>
			<div className="slideshow" style={{ width: `${props.slideWidth}px` }}>
				<div
					...
					onClick={() => {
						if (props.slides101 ? props.slides101.length : 1 > currentSlide) setCurrentSlide(currentSlide + 1);
					}}
				>
				...
				<div className="slides" style={{ width: `${100 * props.slides101 ? props.slides101.length : 1}%` }}>
					<div
						className="slide"
						style={
							currentSlide == 1
								? { width: `${100 / props.slides101 ? props.slides101.length : 1}%` }
								: { marginLeft: `${-(currentSlide - 1) * (100 / props.slides101 ? props.slides101.length : 1)}%` }
						}
					>
